...
<head>
    ...
    <title>Update Data Diskon</title>
    ...
    <div class="container py-5 d-flex justify-content-center align-items-center">
        <div class="card shadow" style="width: 50%">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0">Update Data Diskon</h3>
            </div>
            <div class="card-body">
                <form action="/admin/diskon/update/{{ $disk->diskon_id }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="persen" name="persen" min="0" max="100" value="{{ $disk->persen }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="tglMulai" class="form-label">Tanggal Mulai</label>
                        <input type="date" class="form-control" id="tglMulai" name="tglMulai" value="{{ $disk->tglMulai }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="tglSelesai" class="form-label">Tanggal Selesai</label>
                        <input type="date" class="form-control" id="tglSelesai" name="tglSelesai" value="{{ $disk->tglSelesai }}" required>
                    </div>
                    <div class="mb-3">
